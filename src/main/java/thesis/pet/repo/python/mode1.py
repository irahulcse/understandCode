...
enet_neural_network = cv2.dnn.readNet('/Users/zhudasch/JavaPlayground/ImageAnonymizer/src/python/enet/enet-model.net')

class_names = (
    open('/Users/zhudasch/JavaPlayground/ImageAnonymizer/src/python/enet/enet-classes.txt').read().strip().split("\n"))
